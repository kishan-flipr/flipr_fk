...
class PaytmFailure extends React.Component<IProps> {
  public state = {
                id:this.props.id,
...
public componentDidMount(){
  ...
  public render() {
    ...
    return (
      <div className="message-cl" id="redirect-id">
      <div className="failure-message">
      <i className="fa fa-exclamation-triangle"/>
      <h3>Transaction Failed</h3>
      <p>Payment is failure. Please try after some time.</p>
      </div>
      </div>
    );
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(PaytmFailure);
